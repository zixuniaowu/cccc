...
> Status: **0.4.0rc4** (Release Candidate). Expect breaking changes while we harden UX and contracts.
...
RC tags (e.g. `v0.4.0-rc4`) are published to **TestPyPI**. Use TestPyPI as the primary index, and PyPI as a fallback for dependencies:

...
def render_voice_secretary_actor_system_prompt(group: Group, *, actor: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "- read_new_input returns compact input_text, light input_batches, and relevant document references. Work from input_text first; do not expand batches into item-by-item notes.",

...
Outbox Discipline
- Overwrite `.cccc/mailbox/peerA/to_peer.md` (replace the whole file; do NOT append old content). The orchestrator will consume and may clear it to avoid repeats.

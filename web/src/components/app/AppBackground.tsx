  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 overflow-hidden hidden md:block">
        <div
          className={`absolute -top-32 -left-32 h-96 w-96 rounded-full liquid-blob ${isDark
        ...
        />
        <div
          className={`absolute top-1/4 -right-24 h-80 w-80 rounded-full liquid-blob ${isDark
        ...
        />
        <div
          className={`absolute -bottom-20 left-1/3 h-72 w-72 rounded-full liquid-blob ${isDark
